<script>
	...
	function homeHandler() {
		med.dispatch(SCREEN_ACTIONS.goTo, { route: new Route.Home() })
	}
	...
	function prefsHandler() {
		med.dispatch(SCREEN_ACTIONS.openModal, { modal: new Modal.Pref(Modal.PrefType.edit) })
	}
</script>

<Dialog type="modal" show={Modal.Pause.is($pageState.modal)}>
	<div class="content">
