...
export const ACCESSIBILITIES = new Collection.Builder().addToMain.fromObject(Accessibility).done()
...
export const COLOR_SCHEMAS = new Collection.Builder().addToMain.fromObject(ColorSchema).done()
...
export const ICON_THEMES = new Collection.Builder().addToMain.fromObject(IconTheme).done()
