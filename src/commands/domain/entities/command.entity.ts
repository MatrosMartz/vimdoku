...
export class Cmd {
	...
	static readonly #createCmdToken = new BuildMatcher<readonly [part: string], CmdToken.CmdToken>()
		.addCase(Assert.array([Assert.fromRegex(/^\[[^[\]]*\]$/i)]), t => new CmdToken.Optional(t.slice(1, -1)))
